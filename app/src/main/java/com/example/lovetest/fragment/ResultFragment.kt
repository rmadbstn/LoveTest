...
class ResultFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        option = arguments?.getInt("index")?:-1 //만약 전체가 null 이면 -1을 리턴하겠다. 엘비스연산자.
    ...
    fun setResult(option:Int){
        when(option){
            1 ->{
                tv_main.text = "You are a QUITTER" // == tv.main.setText("")
            ...
            4->{
                tv_main.text = "You are gretty mature"
                tv_sub.text = "You can easily accept the break_up."
            }
        }
    }
